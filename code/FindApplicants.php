...
<html lang="en">
    <head>
        ...
        <title>Internit: Find Applicants</title>
    ...
    <body>
        ...
        <div class="searchArea">
            ...
            <div class="searchApplicants">
                <button  onclick="window.location.href='#'" type="button" class="btn btn-primary btn-lg">Degree Status</button>
                <button onclick="window.location.href='faInterest.php'"  type="button" class="btn btn-primary btn-lg">Interest Area</button>
                ...
                <form id="degreeForm" method="GET" >
                    <select  name="degreeS" onchange='this.form.submit()'>
                        ...
                        $sql = "select * FROM DEGREE_STATUS  ";
                        if ($result = mysqli_query($connection, $sql))
                        {
                            // loop through the data
                            while($row = mysqli_fetch_assoc($result))
                            {
                                echo '<option value="' . $row['DegreeID'] . '">';
                                echo $row['Degree'];
                                echo "</option>";
                            }
                            // release the memory used by the result set
                    ...
                    <table class="table table-hover">
                        ...
                        <?php
                            ...
                            $sql = "    SELECT  FName, LName, PhoneNumber, Email
                                        FROM    APPLICANTS, DEGREE_STATUS
                                        WHERE   DegreeID = {$_GET['degreeS']} AND
                                                DegreeID = Degree_Status";
