    ...
    <body>
        ...
        <div class="searchArea">
            ...
            <div class="searchApplicants">
                <button  onclick="window.location.href='FindOpportunities.php'" type="button" class="btn btn-primary btn-lg">Job Type</button>
                <button onclick="window.location.href='#'"  type="button" class="btn btn-primary btn-lg">Salary Range</button>
                ...
                <form id="degreeForm" method="GET" >
                    <select  name="jobS" onchange='this.form.submit()'>
                        ...
                        $sql = "SELECT 
                                        CASE
                                            WHEN Salary between 60000 and 80000 then 1
                                            WHEN Salary between 80000 and 100000 then 2
                                            ELSE 3 END AS 'test'
                                            FROM JOB_ADS
                                            GROUP BY test  ";
                        if ($result = mysqli_query($connection, $sql))
                    ...
                    <table class="table table-hover">
                        ...
                        <?php
                            ...
                            $sql = "    SELECT JOB_ADS.*, LOCATIONS.*
                                            ...
                                            WHERE {$_GET['jobS']} = 1 AND JOB_ADS.Salary BETWEEN 60000 and 80000
                                            OR {$_GET['jobS']} = 2 AND JOB_ADS.Salary BETWEEN 80000 and 100000
                                            OR {$_GET['jobS']} = 3 AND JOB_ADS.Salary > 100000
                                            ORDER BY JOB_ADS.Salary";
